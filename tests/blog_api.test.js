...
describe("when there are initial blogs saved", () => {
    ...
    test("blogs are returned as json", async () => {
        await api
            ...
            .set(
                "Authorization",
                "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6InJvb3QiLCJpZCI6IjY2ODhlNDkzNDFkZDcwNDFmZDIyZmYzNyIsImlhdCI6MTcyMDI0OTc3MCwiZXhwIjoxNzIwMjUzMzcwfQ.h3EmSnMFi59MYAFXeTIlGxkFjlO4E-YXt3uJocqqKBI",
            )
            .expect(200)
    ...
    describe("addition of new blog", () => {
        ...
        test("blog without likes is defaulted with 0 likes", async () => {
            ...
            const blogsAtEnd = await helper.blogsInDb();
            const blogToCheck = blogsAtEnd.find(
                (blog) => blog.title === "SHEEESH",
            );
